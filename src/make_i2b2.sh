...
echo "db.url=jdbc:postgresql://postgres-0:5432/i2b2?currentSchema=crc" >> db.properties
...
cp "${homedir}"/db.properties .
echo "db.url=jdbc:postgresql://postgres-0:5432/i2b2?currentSchema=hive" >> db.properties
...
db.password=${TF_VAR_I2B2_DB_PASS}
db.driver=org.postgresql.Driver
db.url=jdbc:postgresql://postgres-0:5432/i2b2?currentSchema=metadata
db.project=demo
...
cp "${homedir}"/db.properties .
echo "db.url=jdbc:postgresql://postgres-0:5432/i2b2?currentSchema=pm" >> db.properties
...
cp "${homedir}"/db.properties .
echo "db.url=jdbc:postgresql://postgres-0:5432/i2b2?currentSchema=workdata" >> db.properties
